...
- **Yunsheng Ma**, and Ziran Wang. "Multi-Task Vision Transformer for Semi-Supervised Driver Distraction Detection." Accepted at *NeurIPS Workshop on Machine Learning for Autonomous Driving* (**NeurIPS ML4AD**), 2022. 
[[paper](https://arxiv.org/abs/2209.09178)][[code](https://github.com/PurdueDigitalTwin/ViT-DD)]

- Zhao, Sicheng\*, **Yunsheng Ma\***, Yang Gu, Jufeng Yang, Tengfei Xing, Pengfei Xu, Runbo Hu, Hua Chai, and Kurt Keutzer. "An end-to-end visual-audio attention network for emotion recognition in user-generated videos." *In Proceedings of the AAAI Conference on Artificial Intelligence* (**AAAI**), 2020. [**\*Co-first authors, full paper, oral**]
